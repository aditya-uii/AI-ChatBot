...
className='cursor-pointer min-w-[300px] h-[60px] bg-white rounded-full text-black font-semibold  text-[19px] mt-5'>{!loading?'Create your assistant':loading}</button>
}
